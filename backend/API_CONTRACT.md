...
```json
{
  ...
  "insights": [
    {"label": "Technical Analysis", "text": "BBCA closed at Rp 6,225..."},
    {"label": "Fundamentals", "text": "BBCA demonstrates solid ROE of 20.43%..."},
    {"label": "Market Sentiment", "text": "Market sentiment is a mix..."},
    {"label": "Outlook & Risks", "text": "Medium-term catalysts for BBCA..."}
  ]
}
```

Types: `fundamentals.*` are `number | null`; `prices[].open/high/low/volume` are `number | null`; `insights` is `Array<{label: string, text: string}> | null`.

## GET /stock/{ticker}/insights

Daily per-ticker AI insights generated by Gemini across 4 categories:
- Technical Analysis
- Fundamentals
- Market Sentiment
- Outlook & Risks
  ...
  "insights": [
    {
      ...
      "text": "PT Bank Central Asia Tbk (**BBCA**) closed lower at **Rp 6,225**..."
    },
    {
      "label": "Fundamentals",
      "text": "**BBCA** demonstrates solid banking profitability with a robust ROE of **20.43%**..."
    },
    {
      "label": "Market Sentiment",
      "text": "Market sentiment is a mix of positive earnings momentum..."
    },
    {
      "label": "Outlook & Risks",
      "text": "Medium-term catalysts for **BBCA** hinge on resilient retail credit demand..."
    }
  ]
}
```
