...
//    StockItem(symbol: "BBRI", name: "Bank Rakyat Indonesia Tbk",  price: 4680,   change: -30,   percentChange: -0.64, sentiment: Sentiment(buy: 0.45, hold: 0.35, sell: 0.20, score: 55), market: "IDX", sparkData: [0.6, 0.58, 0.55, 0.50, 0.52, 0.48, 0.45, 0.42, 0.44, 0.40, 0.38, 0.35]),
//    StockItem(symbol: "TLKM", name: "Telkom Indonesia Tbk",       price: 3720,   change:  40,   percentChange:  1.09, sentiment: Sentiment(buy: 0.65, hold: 0.25, sell: 0.10, score: 78), market: "IDX", sparkData: [0.2, 0.25, 0.30, 0.28, 0.35, 0.40, 0.42, 0.50, 0.55, 0.52, 0.60, 0.62]),
//    StockItem(symbol: "UNVR", name: "Unilever Indonesia Tbk",     price: 3940,   change: -65,   percentChange: -1.62, sentiment: Sentiment(buy: 0.20, hold: 0.30, sell: 0.50, score: 32), market: "IDX", sparkData: [0.7, 0.65, 0.60, 0.55, 0.52, 0.48, 0.42, 0.38, 0.35, 0.30, 0.28, 0.25]),
//    StockItem(symbol: "GOTO", name: "GoTo Gojek Tokopedia Tbk",   price: 68,     change:   2,   percentChange:  3.03, sentiment: Sentiment(buy: 0.60, hold: 0.25, sell: 0.15, score: 72), market: "IDX", sparkData: [0.1, 0.15, 0.20, 0.30, 0.35, 0.45, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80]),
//    StockItem(symbol: "AAPL", name: "Apple Inc.",                  price: 197.53, change:  2.14, percentChange:  1.09, sentiment: Sentiment(buy: 0.72, hold: 0.18, sell: 0.10, score: 88), market: "NASDAQ", sparkData: [0.3, 0.32, 0.40, 0.38, 0.45, 0.50, 0.55, 0.60, 0.62, 0.58, 0.65, 0.68]),
//    StockItem(symbol: "NVDA", name: "NVIDIA Corporation",          price: 135.21, change:  4.80, percentChange:  3.68, sentiment: Sentiment(buy: 0.80, hold: 0.12, sell: 0.08, score: 92), market: "NASDAQ", sparkData: [0.1, 0.18, 0.25, 0.35, 0.45, 0.55, 0.62, 0.70, 0.75, 0.80, 0.85, 0.90]),
//    StockItem(symbol: "GGRM", name: "Gudang Garam Tbk",           price: 24950,  change: -275,  percentChange: -1.09, sentiment: Sentiment(buy: 0.30, hold: 0.35, sell: 0.35, score: 42), market: "IDX", sparkData: [0.5, 0.48, 0.45, 0.43, 0.40, 0.38, 0.42, 0.40, 0.37, 0.35, 0.33, 0.30]),
//]
//
...
//        return market.uppercased() == "IDX" ? f : "$\(f)"
//    }
//    var body: some View {
...
//                            Text(chip.label)
//                                .font(.caption2)
//                                .foregroundColor(selectedIndex == index ? accent : .secondary)
//                                .padding(.horizontal, 8).padding(.vertical, 4)
//                                .background(selectedIndex == index ? accent.opacity(0.12) : Color.primary.opacity(0.05))
//                                .clipShape(Capsule())
//                                .overlay(Capsule().strokeBorder(
//                                    selectedIndex == index ? accent.opacity(0.45) : Color.primary.opacity(0.1),
//                                    lineWidth: 0.5))
//                        }
//                        .buttonStyle(.plain)
//                    }
...
//            } else {
//                result = result + Text(part).font(.system(size: 14)).foregroundColor(.primary.opacity(0.85))
//            }
//        }
//        return result
//    }
...
//// ╚══════════════════════════════════════════════════════════════════╝
//
//struct HomeViewStandalone: View {
//
...
//        case "us":  return dummyStocks.filter { $0.market.uppercased() != "IDX" }
...
//        HStack {
//            Text(title).font(.title2).fontWeight(.bold).foregroundColor(.primary)
//            Spacer()
//        }
